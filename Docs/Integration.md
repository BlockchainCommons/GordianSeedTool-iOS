...
2. Choose "xpub / Watch Only Wallet", to keep the seed and private key in **Seed Tool**. This will take you back to the main wallet creation page, but with spaces to enter info about your watch-only key.
