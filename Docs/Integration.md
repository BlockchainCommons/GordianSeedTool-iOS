...
(In a pinch, you could choose Sparrow for 1 of the 3 seeds; though this violates the core security of using a separate transaction coordinator, things remain relatively secure since only 1 of the 2 required seeds is on your computer. This can be done from "New or Imported Software Wallet", where you select "Mnemonic Words" and after you choose to "Enter 12 Words" or "Enter 24 Words", you click "Generate New". You'd do better having two hardware signing devices, however.)
